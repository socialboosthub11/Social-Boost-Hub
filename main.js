...
global.channelLink = "https://whatsapp.com/channel/0029VardNsxHFxP3LwO91S26";
global.ytch = "𝐒𝐎𝐂𝐈𝐀𝐋 𝐁𝐎𝐎𝐒𝐓 𝐇𝐔𝐁";
...
const channelInfo = {
    contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
            ...
            newsletterName: '☣︎𝘾𝙃𝙐𝙋𝙄𝙄 𝙍𝙐𝙎𝙏𝘼𝙈☣︎',
            serverMessageId: -1
        }
    }
};
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029VardNsxHFxP3LwO91S26'
                }, { quoted: message });
                return;
